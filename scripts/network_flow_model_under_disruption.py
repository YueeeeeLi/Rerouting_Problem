...
# %%
# remaining OD matrix
od_df = pd.read_csv(casestudy_path / "outputs" / "od_simulation.csv")
# remaining roads network
road_link_file = gpd.read_parquet(
    casestudy_path / "outputs" / "road_link_remain.geoparquet"
)
...
road_link_file.to_file(
    casestudy_path / "outputs" / "flooded_edge_flow.gpkg",
    driver="GPKG",
)
